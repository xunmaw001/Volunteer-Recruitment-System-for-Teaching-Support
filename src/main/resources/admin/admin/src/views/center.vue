<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='xuexiao'"  label='支援学校名称' prop="xuexiaoName">
               <el-input v-model="ruleForm.xuexiaoName"  placeholder='支援学校名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='xuexiao'"  label='支援学校类型' prop="xuexiaoTypes">
                 <el-select v-model="ruleForm.xuexiaoTypes"  placeholder='请选择支援学校类型'>
                     <el-option
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuexiao'"  label='联系方式' prop="xuexiaoPhone">
               <el-input v-model="ruleForm.xuexiaoPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='xuexiao'"  label='邮箱' prop="xuexiaoEmail">
               <el-input v-model="ruleForm.xuexiaoEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='xuexiao'" label='支援学校封面' prop="xuexiaoPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='xuexiao'"  label="支援学校简介" prop="xuexiaoContent">
                 <editor
                         style="min-width: 200px; max-width: 600px;"
                         v-model="ruleForm.xuexiaoContent"
                         class="editor"
                         action="file/upload">
                 </editor>
             </el-form-item>
...
// 注册表 支援学校 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.xuexiaoName)&& 'xuexiao'==this.flag){
                             this.$message.error('支援学校名称不能为空');
                             return
                         }

                         if((!this.ruleForm.xuexiaoTypes)&& 'xuexiao'==this.flag){
                             this.$message.error('支援学校类型不能为空');
                             return
                         }

                         if((!this.ruleForm.xuexiaoPhone)&& 'xuexiao'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                             if( 'xuexiao' ==this.flag && this.ruleForm.xuexiaoEmail&&(!isEmail(this.ruleForm.xuexiaoEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.xuexiaoPhoto)&& 'xuexiao'==this.flag){
                             this.$message.error('支援学校封面不能为空');
                             return
                         }

                         if((!this.ruleForm.xuexiaoContent)&& 'xuexiao'==this.flag){
