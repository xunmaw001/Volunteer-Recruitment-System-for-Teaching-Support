...
public class ToudiView extends ToudiEntity implements Serializable {
	...
	*/
	...
	//级联表 简历
		...
		*/
		...
		@ColumnInfo(comment="支教时长/年",type="int(11)")
		private Integer jianliShichang;
		/**
		* 简历文件
		*/
	...
	//级联表 职位招聘
		...
		*/
		...
		private Integer zhaopinXuexiaoId;
		/**
		* 招聘信息名称
		*/
		...
		*/
		...
		@ColumnInfo(comment="学校地点",type="varchar(200)")
	...
	*/
	...
	//级联表的get和set 简历
		...
		* 获取： 支教时长/年
		*/
		public Integer getJianliShichang() {
			return jianliShichang;
		}
		/**
		* 设置： 支教时长/年
		*/
		public void setJianliShichang(Integer jianliShichang) {
			this.jianliShichang = jianliShichang;
		}
	...
	//级联表的get和set 职位招聘
		...
		* 获取：职位招聘 的 公司
		*/
		public Integer getZhaopinXuexiaoId() {
			return zhaopinXuexiaoId;
		}
		/**
		* 设置：职位招聘 的 公司
		*/
		public void setZhaopinXuexiaoId(Integer zhaopinXuexiaoId) {
			this.zhaopinXuexiaoId = zhaopinXuexiaoId;
		}
